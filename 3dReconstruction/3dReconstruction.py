...
def main():
    ...
    image_left, image_right = cam.getPicture()

    parser = argparse.ArgumentParser()
    parser.add_argument('left_image', default=image_left, nargs='?')
    parser.add_argument('right_image', default=image_right, nargs='?')
    parser.add_argument('focal_length', type=float, const=480., nargs='?')
    parser.add_argument('distance_between_cameras', type=float, const= 585., nargs='?')
